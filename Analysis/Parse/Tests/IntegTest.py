...
def test_prepare_for_analysis():
    with open('files/simple.yaml', 'r') as file:
        content = file.read()
...
def test_multiple_jobs():
    with open('files/multijobs.yaml', 'r') as file:
        content = file.read()
    action = Action(content=content)
    workflow = action.prepare_for_analysis()
...
def test_optional_parameters():
    with open('files/optionalparams.yaml', 'r') as file:
        content = file.read()
    action = Action(content=content)
    workflow = action.prepare_for_analysis()
...
def test_steps_with_different_commands():
    with open('files/diffcommands.yaml', 'r') as file:
        content = file.read()
    action = Action(content=content)
    workflow = action.prepare_for_analysis()
...
def test_default_values():
    with open('files/nonevalues.yaml', 'r') as file:
        content = file.read()
    action = Action(content=content)
    workflow = action.prepare_for_analysis()
...
def test_parsing_errors():
    with open('files/invalid.yaml', 'r') as file:
        content = file.read()
...
def test_conditional_workflow():
    with open('files/conditionals.yaml', 'r') as file:
        content = file.read()
...
def test_input_output_workflow():
    with open('files/i_o.yaml', 'r') as file:
        content = file.read()
...
def test_containers_workflow():
    with open('files/container.yaml', 'r') as file:
        content = file.read()
...
def test_defaults_workflow():
    with open('files/defaults.yaml', 'r') as file:
        content = file.read()
...
def test_continue_on_error_workflow():
    with open('files/continueonerro.yaml', 'r') as file:
        content = file.read()
...
def test_needs_workflow():
    with open('files/needs.yaml', 'r') as file:
        content = file.read()
...
def test_service_workflow():
    with open('files/services.yaml', 'r') as file:
        content = file.read()
...
def test_strategy_workflow():
    with open('files/strategy.yaml', 'r') as file:
        content = file.read()
...
def test_timeout_workflow():
    with open('files/timeout.yaml', 'r') as file:
        content = file.read()
